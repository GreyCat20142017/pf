  ...
  render() {
    ...
    return  (
      <div className='project card border-secondary h-100 shadow-lg' tab-index='0' style={{maxWidth: '310px'}}>
        ...
        <div className='project__body card-body h-100 d-none d-md-block'>
        ...
        <div className='project__buttons card-footer bg-transparent'>
          ...
          <button className='btn btn-outline-secondary btn-block text-centerd-flex d-md-none' type='button'>Развернуть</button>
        </div>
      </div>
      )
  }
